...
func newHTTP1Client(opts Opts) (context.Context, Client, error) {
	return context.Background(), httpClient(http1.NewFacade(opts.ArgoServerOpts.GetURL(), opts.AuthSupplier(), opts.ArgoServerOpts.InsecureSkipVerify, opts.ArgoServerOpts.Headers, opts.ArgoServerOpts.HTTP1Client, opts.ArgoServerOpts.ClientCert, opts.ArgoServerOpts.ClientKey)), nil
}
